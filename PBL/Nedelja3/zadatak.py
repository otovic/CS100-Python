def zadatak_nedelja3():
    ...
    while odgovor in ['1', '2', '3', '4']:
        if odgovor == '1':
            niz = cita_i_pretvara_u_niz("Nedelja3/podaci.txt")  
            ispisuje_u_terminalu(niz)
        elif odgovor == '2':
            broj = int(input("Koliko serijskih brojeva zelite dodati?\n"))
            dodaj_serijske_brojeve("Nedelja3/podaci.txt", broj)
        elif odgovor == '3':
            broj = int(input("Koliko serijskih brojeva zelite upisati?\n"))
            upisi_serijske_brojeve("Nedelja3/podaci.txt", broj)
        elif odgovor == '4':
            serijskiBroj = str(input("Koj serijski broj kontejnera zelite da zamenite: "))
            menja_u_znak("Nedelja3/podaci.txt", serijskiBroj)
        else:
            break
