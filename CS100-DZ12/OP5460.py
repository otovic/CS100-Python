...
try:
    opcija = 10
    recnik = procitaj_Fajl('opstine.metropolitan')
    while opcija != 0:
        ...
        if opcija == 2:
                recnik = dodaj_Opstinu('opstine.metropolitan', recnik)
                prikazi_Recnik(recnik)
        if opcija == 3:
                recnik = isprazni_Kontejner('opstine.metropolitan', recnik)
                prikazi_Recnik(recnik)
        if opcija == 4:
                recnik = izbrisi_Opstinu('opstine.metropolitan', recnik)
                prikazi_Recnik(recnik)
        if opcija == 5:
                recnik = upisi_Podatke('opstine.metropolitan', pitaj_za_opstinu(recnik))
                prikazi_Recnik(recnik)
        if opcija == 6:
                break
